        ...
        <div className="relative min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-purple-400 via-pink-500 to-red-500 p-4 overflow-hidden">
            ...
            >
                <div className="flex flex-col space-y-2 text-center">
                    ...
                    <p className="text-sm text-gray-500 italic">Unblur your perfect match</p>
                ...
                <form onSubmit={onSubmit}>
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input id="email" placeholder="m@example.com" value={formData.email} onChange={handleInputChange} required type="email" />
                        </div>
                        <div className="space-y-2">
                            <Label htmlFor="password">Password</Label>
                            <Input id="password" value={formData.password} onChange={handleInputChange} required type="password" />
                        </div>
                        <Button
